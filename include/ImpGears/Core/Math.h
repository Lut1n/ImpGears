...
IG_CORE_API void RandSeed(double s = 0.0);

IG_CORE_API double Rand(double min, double max, double precision = 1.0e-9);

IG_CORE_API double Frac(double t);

IG_CORE_API double Hermite(double t);

IG_CORE_API double Quintic(double t);

IG_CORE_API double Lerp(double a, double b, double t);

IG_CORE_API double Sin(double t, double maxPeriodRatio = 0.5);

IG_CORE_API double SquareSignal(double t, double maxPeriodRatio = 0.5);

IG_CORE_API double TriangleSignal(double t, double maxPeriodRatio = 0.5);
