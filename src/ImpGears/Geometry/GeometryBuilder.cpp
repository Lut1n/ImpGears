...
//--------------------------------------------------------------
Geometry::Ptr GeometryBuilder::createCapsule(int sub, float r, float dlen)
{
    float ex = dlen+r;
    ...
    Geometry::intoCCW(*res, true);
    res->generateColors(Vec3(1.0,1.0,1.0));
    res->generateNormals(Geometry::NormalGenMode_PerFace);
    res->generateTexCoords(Geometry::TexGenMode_Cubic);
    res->interpolateNormals();

    return res;
}

//--------------------------------------------------------------
Geometry::Ptr GeometryBuilder::createCrystal(int sub, float r, float dlen)
{
    float ex = dlen+r;
...
//--------------------------------------------------------------
Geometry::Ptr GeometryBuilder::createCylinder(int sub, float r, float dlen)
{
    CircleSampler bot_base(Vec3(0.0,-dlen,0.0),r,Vec3::Y,sub);
    CircleSampler top_base(Vec3(0.0,dlen,0.0),r,Vec3::Y,sub);
    ...
    cylindricNormalInterpo(res);

    return res;
}

//--------------------------------------------------------------
Geometry::Ptr GeometryBuilder::createTorus(int sub, float mr, float r)
{
...
//--------------------------------------------------------------
Geometry::Ptr GeometryBuilder::createCube(float s)
{
...
//--------------------------------------------------------------
Geometry::Ptr GeometryBuilder::createSphere(int sub, float r)
{
    Geometry::Ptr newGeo = Geometry::create();
    *newGeo = Geometry::sphere(sub,r);
    Geometry::intoCCW(*newGeo, true);
    newGeo->generateColors(Vec3(1.0,1.0,1.0));
...
//--------------------------------------------------------------
void GeometryBuilder::cylindricNormalInterpo(Geometry::Ptr& geo)
{
